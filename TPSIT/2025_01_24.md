...
Con questa tipologia di architettura a oggni non sono ancora state costruite macchine da commercializzare, anche se il modello ricorda la modalità di esecuzione delle istruzioni in pipeline.
